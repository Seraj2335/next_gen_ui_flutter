...
import 'package:next_gen_app/common/shader_effect.dart';
import 'package:next_gen_app/common/ticking_builder.dart';
import 'package:next_gen_app/common/ui_scaler.dart';
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              ...
              .shimmer(delay: .7.seconds, color: Color(0xff000000)),
        )
            .animate()
